...
export function AppShell({ header, children, bottomNavigation, className }: AppShellProps) {
  return (
    <div className={cn('min-h-screen bg-slate-50 text-slate-950 dark:bg-[#101314] dark:text-[#E8F1F6]', className)}>
      {header ? (
        <div className="border-b border-slate-200 bg-white dark:border-[#24292D] dark:bg-[#101314]">
